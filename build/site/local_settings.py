...
#SECRET_KEY = '&aex)-fzi)$mg@^y@snoj8@27i!*e^s3*ok55y3i@ksng&vkm^'
...
SITE_NAME = 'iSOJ'
SITE_LONG_NAME = 'iSPACE Online Judge'
SITE_ADMIN_EMAIL = 'admin@ispace.edu.com'
TERMS_OF_SERVICE_URL = '/terms/' # Use a flatpage.
